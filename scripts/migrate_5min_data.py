"""
Migrate 5-minute OHLCV data from v2_stocks_5min to stocks_5min_clean
...
print("="*80)
print("MIGRATING 5-MINUTE DATA")
print("="*80)

# SQL to copy base data (OHLCV + metadata)
# Leave all indicator fields NULL - they'll be calculated by calculate_5min_indicators.py
migration_query = """
INSERT INTO `aialgotradehits.crypto_trading_data.stocks_5min_clean`
(
    datetime, symbol,
...
try:
    ...
    print("="*80)
    print("\nNext step: Run calculate_5min_indicators.py to add indicators")
