...
import {
  ...
  PieChart, DollarSign, Globe, Activity, Coins, Database, HardDrive, FileSpreadsheet, Download, FlaskConical, Layers, Award
} from 'lucide-react';
...
const Navigation = ({ currentView, onViewChange, onMenuToggle, isMenuOpen, currentUser, onSearch }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      path: '/trade-analysis',
      badge: 'HOT',
      description: 'Multi-timeframe trading: Daily, Hourly & 5-Min analysis'
    },
    {
      ...
      badge: 'DAILY',
      description: 'Daily ranked opportunities across all asset types'
    },
    {
      id: 'weekly',
      ...
      path: '/weekly',
      badge: 'NEW',
      description: 'Weekly market analysis across all asset types',
      submenu: [
        { id: 'dashboard', label: 'Weekly Dashboard', icon: LineChart, badge: 'NEW' },
        { id: 'stocks', label: 'Stocks Weekly', icon: TrendingUp },
        { id: 'cryptos', label: 'Crypto Weekly', icon: Coins },
        { id: 'etfs', label: 'ETFs Weekly', icon: PieChart },
        { id: 'forex', label: 'Forex Weekly', icon: DollarSign },
        { id: 'indices', label: 'Indices Weekly', icon: Globe },
        { id: 'commodities', label: 'Commodities Weekly', icon: Activity },
      ]
    },
    {
      id: 'ai-signals',
    ...
    },
    {
      ...
      path: '/market-movers',
      badge: 'LIVE',
      description: 'Top gainers and losers across all markets'
    },
    {
      id: 'fundamentals',
      label: 'Fundamentals',
    ...
    },
    {
      ...
      path: '/etf-analytics',
      badge: 'NEW',
      description: 'ETF profiles, performance and holdings'
    },
    {
      id: 'ai-training',
      label: 'AI Training',
  ...
  if (currentUser?.role === 'admin') {
    ...
    menuItems.push({
      ...
      badge: 'XLSX',
      description: 'Download complete database summary as Excel'
    });
    menuItems.push({
      id: 'data-export',
      label: 'Data Export (97 Fields)',
      icon: Download,
      path: '/data-export',
      badge: 'CSV',
      description: 'Download complete stock/crypto data with all 97 fields'
    });
    menuItems.push({
      id: 'ml-test-data',
      label: 'ML Test Data',
      ...
      path: '/ml-test-data',
      badge: 'ML',
      description: '10 pre-configured test datasets for ML model validation'
    });
    menuItems.push({
      id: 'walk-forward',
      ...
      path: '/walk-forward',
      badge: 'PRO',
      description: 'ML walk-forward validation system with configurable parameters'
    });
  }
