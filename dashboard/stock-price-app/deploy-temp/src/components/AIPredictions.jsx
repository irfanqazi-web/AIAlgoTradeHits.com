...
function AIPredictions({ symbol = 'BTCUSD', timeframe = 'daily' }) {
  ...
  const fetchPredictions = async () => {
    ...
    const result = await aiService.getPricePrediction(symbol, timeframe, selectedProvider)
  ...
  const renderPredictionCard = (providerName, prediction) => {
    ...
    const trend = aiService.getTrendIndicator(prediction.trend)
    const signal = aiService.getSignalStrength(prediction.recommendation)
